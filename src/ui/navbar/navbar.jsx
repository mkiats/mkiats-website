  ...
  return (
    <div className="h-full flex justify-between items-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
      ...
      <div className="md:hidden lg:flex justify-center xl:w-1/3">
        <Link
          href="/"
          className="text-sm bg-black rounded-md p-1 flex font-semibold justify-center items-center"
        >
          <span className="text-white mr-1">mkiats</span>
          <span className="w-12 h-8 bg-white rounded-md flex items-center justify-center ">
            .dev
          </span>
        </Link>
      </div>
      ...
      <div className="md:hidden">
        <button className="z-10 relative" onClick={() => setOpen(!open)}>
